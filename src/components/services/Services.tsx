            ...
            <div className="services__modal-content">
              ...
              <ul className="services__modal-services grid">
                  ...
                  <li className="services__modal-service">
                    <i className="uil uil-check-circle services__modal-icon"></i>
                    <p className="services__modal-info">
                      I develop REST APIs using Golang or Node.js.
                    </p>
                  </li>
                  ...
                  <li className="services__modal-service">
                    <i className="uil uil-check-circle services__modal-icon"></i>
                    <p className="services__modal-info">
                      I design and manage databases with MySQL or PostgreSQL.
                    </p>
                  </li>
                  ...
                  <li className="services__modal-service">
                    <i className="uil uil-check-circle services__modal-icon"></i>
                    <p className="services__modal-info">
                      I create basic POS (Point of Sale) applications for small
                      businesses.
                    </p>
                  </li>
                  ...
                  <li className="services__modal-service">
                    <i className="uil uil-check-circle services__modal-icon"></i>
                    <p className="services__modal-info">
                      I am continuously learning and open to collaboration.
                    </p>
                  </li>
              </ul>
            </div>
